...
<html>
	<head>
		...
		<title>Enieco - Global Engineering and Facility Management Solutions Provider</title>	

		<meta name="keywords" content="inspection, expedition, engineering, technical staffing, marine survey, NDT service, asset integrity" />
		<meta name="description" content="Enieco - a preeminent multi disciplined Oil & Gas Technical Service Provider, for customers in the Private, Public and Government sectors on Oil, Gas, Marine, Petrochemical and Power Industries all around the Globe.">
	...
	<body class="loading-overlay-showing" data-loading-overlay data-plugin-options="{'hideDelay': 500, 'effect': 'floatBars'}">
		...
		<div class="body">
							...
							<div class="header-column">
								<div class="header-row">
									<div class="header-logo">
										<a href="/">
											<img alt="Enieco Logo" src="/img/logos/enieco_logo.png">
										</a>
									</div>
								</div>
							</div>
							<div class="header-column justify-content-end">
								<div class="header-row">
									<div class="header-nav header-nav-links">
										<div class="header-nav-main header-nav-main-square header-nav-main-dropdown-no-borders header-nav-main-dropdown-border-radius header-nav-main-text-capitalize header-nav-main-text-size-4 header-nav-main-arrows header-nav-main-full-width-mega-menu header-nav-main-mega-menu-bg-hover header-nav-main-effect-2">
											<nav class="collapse">
												<ul class="nav nav-pills" id="mainNav">
                                                    ...
                                                    <li class="dropdown">
														<a href="demo-business-consulting-4.html" class="nav-link">
															ABOUT US
														</a>
													</li>
													<li class="dropdown">
										...
										<a href="/" class="btn btn-modern btn-primary btn-outline btn-arrow-effect-1 text-capitalize text-2-5 ms-3 me-2 d-block d-md-none d-xl-block anim-hover-translate-right-5px transition-2ms">Contact Us <i class="fas fa-arrow-right ms-2"></i></a>
			...
			<div role="main" class="main">
							...
							<div class="col">
								<div class="row pt-5 mt-5 mb-5 pb-5">
									<div class="col-12 col-lg-6 p-relative pt-5 mt-5">
										...
										<h1 class="text-color-dark font-weight-bold text-9 pb-2 mb-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200">ESPERTO NOVERO INSPECTION AND ENGINEERING CONSULTANTS</h1>
				...
				<section class="parallax section section-text-light section-parallax bg-primary m-0" data-plugin-parallax data-plugin-options="{'speed': 1.5}" data-image-src="img/demos/business-consulting-4/parallax/parallax-1.jpg">
					<div class="container py-5">
						<div class="row justify-content-center">
							<div class="col">
								...
								<a href="demo-business-consulting-4-blog-post.html" class="text-decoration-none">
									<div class="card border-0 bg-transparent">
										<div class="card-img-top position-relative overlay overflow-hidden border-radius">
											...
											<img src="img/demos/business-consulting-4/blog/post-thumb-1.jpg" class="img-fluid border-radius" alt="Lorem Ipsum Dolor" />
										</div>
								...
								<a href="demo-business-consulting-4-blog-post.html" class="text-decoration-none">
									<div class="card border-0 bg-transparent">
										<div class="card-img-top position-relative overlay overflow-hidden border-radius">
											...
											<img src="img/demos/business-consulting-4/blog/post-thumb-2.jpg" class="img-fluid border-radius" alt="Lorem Ipsum Dolor" />
										</div>
										<div class="card-body py-4 px-0">
											<span class="d-block text-color-grey font-weight-semibold positive-ls-2 text-2">BY ADMIN</span>
											<h4 class="font-weight-bold text-5 text-color-hover-primary mb-2">Lorem ipsum dolor sit a met, consectetur</h4>
								...
								<a href="demo-business-consulting-4-blog-post.html" class="text-decoration-none">
									<div class="card border-0 bg-transparent">
										<div class="card-img-top position-relative overlay overflow-hidden border-radius">
											...
											<img src="img/demos/business-consulting-4/blog/post-thumb-3.jpg" class="img-fluid border-radius" alt="Lorem Ipsum Dolor" />
										</div>
										<div class="card-body py-4 px-0">
											<span class="d-block text-color-grey font-weight-semibold positive-ls-2 text-2">BY ADMIN</span>
											<h4 class="font-weight-bold text-5 text-color-hover-primary mb-2">Lorem ipsum dolor sit a met, consectetur</h4>
