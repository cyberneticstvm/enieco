							...
							<div class="header-column justify-content-end">
								<div class="header-row">
									<div class="header-nav header-nav-links">
										<div class="header-nav-main header-nav-main-square header-nav-main-dropdown-no-borders header-nav-main-dropdown-border-radius header-nav-main-text-capitalize header-nav-main-text-size-4 header-nav-main-arrows header-nav-main-full-width-mega-menu header-nav-main-mega-menu-bg-hover header-nav-main-effect-2">
											<nav class="collapse">
												<ul class="nav nav-pills" id="mainNav">
                                                    ...
                                                    <li class="dropdown">
														<a href="/about" class="nav-link {{ Request::path() === 'about' ? 'active' : '' }}">
															ABOUT US
														</a>
													</li>
													<li class="dropdown">
                                                    ...
                                                    <li>
														<a class="nav-link {{ Request::path() === 'clients' ? 'active' : '' }}" href="/clients">
															CLIENTS
														</a>
													</li>
                                                    <li>
														<a class="nav-link {{ Request::path() === 'careers' ? 'active' : '' }}" href="/careers">
															CAREERS
														</a>
													</li>
												</ul>
										...
										<a href="/contact" class="btn btn-modern btn-primary btn-outline btn-arrow-effect-1 text-capitalize text-2-5 ms-3 me-2 d-block d-md-none d-xl-block anim-hover-translate-right-5px transition-2ms">CONTACT US<i class="fas fa-arrow-right ms-2"></i></a>
